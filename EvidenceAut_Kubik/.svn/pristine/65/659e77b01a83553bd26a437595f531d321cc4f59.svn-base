...
import automobily.SeznamVozidel;
...
public class EvidenceAutomobilu extends Application {
    ...
    SeznamVozidel seznam = SeznamVozidel.getInstance();
    ...
    public void start(Stage primaryStage) throws KolekceException {
        ...
        int a = 130;
        children.add(VytvareniKomponent.newBtn("Test", 10 + a, 15, 
                TestData.runTestData(this)));
